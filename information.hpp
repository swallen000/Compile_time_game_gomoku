...
// using STR
// we can not pass non-constexpr variable to initialize template at compile time
...
// Get current_state (turn, input x, input y, placed) from current.txt
// Use cout to construct next_state
// using STR
